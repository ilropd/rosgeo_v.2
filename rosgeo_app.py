...
loaded_model_KNEF.load_weights('venv/Models/KNEF/model_ilro_KNEF_weights.h5')
print('Loaded model KNEF from disk')

json_file_KPEF = open('venv/Models/KPEF/KPEF_baseline_model.json', 'r')
loaded_model_json_KPEF = json_file_KPEF.read()
json_file_KPEF.close()
loaded_model_KPEF = model_from_json(loaded_model_json_KPEF)
loaded_model_KPEF.load_weights('venv/Models/KPEF/KPEF_baseline_weights.h5')
print('Loaded model KNEF from disk')
